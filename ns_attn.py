...
class TokenSelection(nn.Module):
    ...
    def forward(
        self, x: torch.Tensor, attention_scores: torch.Tensor
...
class NativeSparseAttention(nn.Module):
    ...
    def forward(
        ...
        final_output = (
            g_comp * compressed_output + g_sel * selected_tokens + g_win * window_output
        )
...
"""
    compression_block_size = 32  # l
    sliding_stride = 16       # d
    selected_block_size = 64  # l`
    selected_block_count = 16  # n
    sliding_window_size = 512  # u
"""